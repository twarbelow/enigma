...
# The third is the key to be used for decryption. The fourth is the date to be used for decryption.
# In addition to writing the decrypted message to the file,
# your program should output to the screen the file it wrote to, the key used for decryption,
# and the date used for decryption.
